var questionsArray = [
    {
       question: "What does HTML stand for?",
        options: ["Hyper Text Markup Language", "Home Tool Markup Language", "Hyperlinks and Text Markup Language" , "Hyper Tool and Markup Language"],
    ...
    },
    {
        ...
        options: ["<a href= 'url' >Link</a>", "<link src= 'url' >Link</link>", "<hyperlink>Link</hyperlink>" , "<url>Link</url>"],
    ...
    },
    {
        ...
        options: ["<body style= 'background-color:blue;'>", "<body bg='blue'>", "<background>blue</background>" , "<body style='color:blue;'>"],
    ...
    },
    {
        ...
        options: [ "<input type='text'>", "<input type='button'>" , "<input type='reset'>","<input type='submit'>"],
    ...
    },
    {
        ...
        options: [ "<checkbox>", "<input type='check'>" , "<input type='box'>","<input type='checkbox'>"],
    ...
    },
    {
        ...
        options: [ "An anchor point","A hyperlink", "A text decoration" , "A paragraph"],
    ...
    },
    {
        ...
        options: [ "To define a navigation section", "To define the main header" ,"To define self-contained content", "To define a paragraph"],
    ...
    },
    {
        ...
        options: [ "To define the main header", "To emphasize text" ,"To define content aside from the main content", "To create a sidebar"],
    ...
    },
    {
        ...
        options: [ "To underline text","To highlight text", "To italicize text" , "To bold text"],
...
for (var i = 0; i < questionsArray.length; i++) {
    ...
    for (var j = 0; j < questionsArray[i].options.length; j++) {
        ...
        optionLabel.appendChild(document.createTextNode(questionsArray[i].options[j]));
